...
1. Кредит по данным карты, оставить поле пустым с НОМЕР КАРТЫ    
Остальные поля заполнены валидными значениями  
Ожидаемый результат: под полем НОМЕР КАРТЫ появилось сообщение об ошибке "Неверный формат"

1. Кредит по данным карты, оставить поле пустым с МЕСЯЦ    
...
1. Кредит по данным карты, оставить поле пустым с ГОД    
Номер карты 4444 4444 4444 4441. Остальные поля заполнены валидными значениями  
Ожидаемый результат: под полем ГОД появилось сообщение об ошибке "Неверный формат"

1. Кредит по данным карты, оставить поле пустым с ВЛАДЕЛЕЦ    
Номер карты 4444 4444 4444 4441. Остальные поля заполнены валидными значениями  
Ожидаемый результат: под полем ВЛАДЕЛЕЦ появилось сообщение об ошибке "Поле обязательно для заполнения"

1. Кредит по данным карты, оставить поле пустым с CVC/CVV   
Номер карты 4444 4444 4444 4441. Остальные поля заполнены валидными значениями  
Ожидаемый результат: под полем CVC/CVV появилось сообщение об ошибке "Неверный формат"

1. Оплата по данным карты, оставить поле пустым с НОМЕР КАРТЫ    
Остальные поля заполнены валидными значениями  
Ожидаемый результат: под полем НОМЕР КАРТЫ появилось сообщение об ошибке "Неверный формат"

1. Оплата по данным карты, оставить поле пустым с МЕСЯЦ    
Номер карты 4444 4444 4444 4441. Остальные поля заполнены валидными значениями  
Ожидаемый результат: под полем МЕСЯЦ появилось сообщение об ошибке "Неверный формат"

1. Оплата по данным карты, оставить поле пустым с ГОД    
Номер карты 4444 4444 4444 4441. Остальные поля заполнены валидными значениями  
Ожидаемый результат: под полем ГОД появилось сообщение об ошибке "Неверный формат"

1. Оплата по данным карты, оставить поле пустым с ВЛАДЕЛЕЦ    
Номер карты 4444 4444 4444 4441. Остальные поля заполнены валидными значениями  
Ожидаемый результат: под полем ВЛАДЕЛЕЦ появилось сообщение об ошибке "Поле обязательно для заполнения"

1. Оплата по данным карты, оставить поле пустым с CVC/CVV   
Номер карты 4444 4444 4444 4441. Остальные поля заполнены валидными значениями  
Ожидаемый результат: под полем CVC/CVV появилось сообщение об ошибке "Неверный формат"
